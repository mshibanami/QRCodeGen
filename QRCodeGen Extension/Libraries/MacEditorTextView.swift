...
struct MacEditorTextView: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> CustomTextView {
        let textView = CustomTextView(text: self.text, isEditable: isEditable, font: font)
...
struct MacEditorTextView_Previews: PreviewProvider {
    static var previews: some View {
        let font = NSFont.systemFont(ofSize: 32, weight: .ultraLight)
        return Group {
            MacEditorTextView(text: .constant("{ \n    planets { \n        name \n    }\n}"), font: font, isEditable: true)
